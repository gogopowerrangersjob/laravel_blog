			...
			<div class="col-md-8">
				...
				<div class="row"><!--blog next previous-->
					<div class="col-md-6">
						...
						<div class="single-blog-box">
							<a href="{{route('post.show', $post->getPrev()->slug)}}">
								<img src="{{$post->getPrev()->getImage()}}" alt="">

								<div class="overlay">

									<div class="promo-text">
										<p><i class=" pull-left fa fa-angle-left"></i></p>
										<h5>{{$post->getPrev()->title}}</h5>
									</div>
								</div>
				...
				<div class="bottom-comment"><!--bottom comment-->
					...
					<div class="comment-img">
						<img width="75" height="75" class="img-circle" src="{{$comment->author->getImage()}}" alt="">
					</div>
